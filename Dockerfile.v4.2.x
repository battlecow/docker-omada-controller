...
RUN \
  ...
  cd /tmp &&\
  wget -nv "https://static.tp-link.com/2021/202102/20210209/Omada_SDN_Controller_v4.2.11_linux_x64.tar.gz" &&\
  echo "**** Extract and Install Omada Controller ****" &&\
  tar zxvf Omada_SDN_Controller_v4.2.11_linux_x64.tar.gz &&\
  rm Omada_SDN_Controller_v4.2.11_linux_x64.tar.gz &&\
